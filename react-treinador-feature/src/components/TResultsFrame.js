      ...
      <div>
          <div className="table-top">
            <div className="table-top-left">
                ...
                <select id="desdeselect" name="Desde" defaultValue="Desde"
                        onChange={
                            () => {
                ...
                <h5> - </h5>
                <select id="ateselect" name="Até" defaultValue="Até"
                        onChange={
                            () => {
            ...
            <div className="table-top-right">
                <h5> Atleta </h5>
                <select id="atletasselect" name="" defaultValue="-"
                        onChange={
                            () => {
            ...
            <div className="table-top-right">
                <h5> Modalidade </h5>
                <select id="modalidadeSelect" defaultValue="-"
                        onChange={
                            () => {
